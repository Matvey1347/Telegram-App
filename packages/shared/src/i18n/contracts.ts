...
> = {
  ...
  TELEGRAM_PUBLICATION_SLOT_INVALID: "telegramPosts.errors.publicationSlotInvalid",
  TELEGRAM_PUBLICATION_SLOT_OCCUPIED: "telegramPosts.errors.publicationSlotOccupied",

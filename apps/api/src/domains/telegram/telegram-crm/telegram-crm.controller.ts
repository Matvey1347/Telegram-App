...
export class TelegramCrmController {
  ...
  @Get('contacts/:id/chat-context')
  getChatContext(@CurrentUser() user: JwtUser, @Param('id') id: string) {
    return this.contactRead.getChatContext(user.sub, id);
  }

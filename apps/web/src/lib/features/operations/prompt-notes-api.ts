...
export function createPromptNotesApi({ api, getPaginated, getAllPaginatedItems, hasExplicitPagination, silentFeedbackConfig }: {
  api: AxiosInstance;
...
const promptNotesApi = {
  ...
  remove: async (id: string) =>
    (await api.delete(`/prompt-notes/${id}`, silentFeedbackConfig)).data,
};

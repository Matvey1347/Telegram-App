...
const metricIconMatches: MetricIconMatch[] = [
  ...
  {
    tokens: ["cpm", "cpa", "price", "revenue", "outstanding", "underpricing"],
    icon: BadgeDollarSign,
    toneClassName: "text-emerald-300",
  },
  {
    tokens: ["views", "view rate", "err"],
    icon: Eye,
    toneClassName: "text-sky-300",
  },
  {
    tokens: ["subscribers", "joined", "attributed"],
    icon: Users,
    toneClassName: "text-violet-300",
  },
  {
    tokens: ["active subscribers", "active estimate", "active"],
    icon: UserCheck,
    toneClassName: "text-emerald-300",
  },
  {
    tokens: ["known fake subscribers", "fake subscribers"],
    icon: UserX,
    toneClassName: "text-rose-300",
  },
  {
    tokens: ["inactive subscribers", "inactive"],
    icon: UserMinus,
    toneClassName: "text-amber-300",
  },
  {
    tokens: ["pending requests", "pending"],
    icon: UserPlus,
    toneClassName: "text-amber-300",
  },
  {
    tokens: ["placements", "slots", "upcoming"],
    icon: CalendarRange,
  ...
  {
    tokens: ["fill rate", "rate"],
    icon: Percent,
    toneClassName: "text-teal-300",
  },
  {
    tokens: ["underpricing loss"],
    icon: CircleMinus,
    toneClassName: "text-rose-400",
  },
  {

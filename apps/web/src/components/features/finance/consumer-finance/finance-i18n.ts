...
const en = {
  ...
  reminders: "Reminders",
  remindersHelp: "Get a monthly Telegram alert before an expected payment or income. A reminder never creates a transaction.",
  reminderName: "Reminder name",
  reminderAmount: "Expected amount",
  reminderAmountHelp: "Used in forecasts and shown in the alert; money is not added or deducted automatically.",
...
const uk: FinanceCopy = {
  ...
  remindersHelp: "Отримуйте щомісячне нагадування в Telegram перед очікуваним платежем або доходом. Нагадування не створює операцію.",
  reminderName: "Назва нагадування",
  reminderAmount: "Очікувана сума",
  reminderAmountHelp: "Використовується у прогнозі та показується в нагадуванні; гроші не списуються й не додаються автоматично.",

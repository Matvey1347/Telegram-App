      ...
      >
        <div className="mb-1 flex items-center justify-between p-4 pb-3 sm:p-5 sm:pb-3">
          ...
          <button
            ...
            onClick={onClose}
            className="cursor-pointer rounded-lg border border-neutral-700 p-2 hover:bg-neutral-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
          >
            <X size={16} />
          </button>
        </div>

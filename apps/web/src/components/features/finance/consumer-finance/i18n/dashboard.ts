...
const copy = {
  en: {
    ...
    net: "Period remainder",
    netExplanation: "Income + investment returns − expenses − invested",
  ...
  uk: {
    ...
    net: "Залишок за період",
    netExplanation: "Доходи + повернення інвестицій − витрати − інвестовано",
  ...
  ru: {
    ...
    net: "Остаток за период",
    netExplanation: "Доходы + возвраты инвестиций − расходы − инвестировано",

...
const copy = {
  en: {
    ...
    thinking: "Working…",
    stop: "Stop",
    thinkingStages: ["Jarvis is reading the details…", "Jarvis is preparing a safe proposal…", "Jarvis is checking the financial meaning…"],
    error: "I could not process that. Clarify the details and try again.",
    providerError: "The AI service is temporarily unavailable. Nothing was recorded; please try again.",
    proposal: "Check before recording",
    preparedProposal: "I prepared {count} transaction(s) for your review.",
  ...
  uk: {
    ...
    thinking: "Працюю…",
    stop: "Зупинити",
    thinkingStages: ["Джаврис читає деталі…", "Джаврис готує безпечну пропозицію…", "Джаврис перевіряє фінансовий зміст…"],
    error: "Не вдалося це обробити. Уточніть деталі й спробуйте ще раз.",
    providerError: "Сервіс AI тимчасово недоступний. Запис не створено; спробуйте ще раз.",
    proposal: "Перевірте перед записом",
    preparedProposal: "Джаврис підготував операції для перевірки: {count}.",
  ...
  ru: {
    ...
    thinking: "Разбираюсь…",
    stop: "Остановить",
    thinkingStages: ["Джаврис читает детали…", "Джаврис готовит безопасное предложение…", "Джаврис проверяет финансовый смысл…"],
    error:
      "Не получилось это обработать. Уточните детали и попробуйте ещё раз.",
    providerError: "Сервис AI временно недоступен. Запись не создана; попробуйте ещё раз.",
    proposal: "Проверьте перед записью",
    preparedProposal: "Джаврис подготовил операций для проверки: {count}.",

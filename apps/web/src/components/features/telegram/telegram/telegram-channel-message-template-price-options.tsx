...
export function TelegramChannelMessageTemplatePriceOptions({
  ...
  return (
    <div className="grid gap-4 rounded-xl border border-neutral-800 bg-neutral-950/50 p-3 lg:grid-cols-[minmax(0,1.3fr)_minmax(250px,.7fr)]">
                    ...
                    onChange={(event) =>
                      onExcludedProductNamesChange(
                        event.target.checked
                          ? excludedProductNames.filter((item) => item !== name)

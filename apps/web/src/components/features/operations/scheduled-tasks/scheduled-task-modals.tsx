    ...
    >
      ...
      <fieldset className="space-y-2 rounded-lg border border-neutral-800 p-3">
        <legend className="px-1 text-sm font-medium text-neutral-200">
          Execution-wide notification delivery
        </legend>
        <p className="text-xs text-neutral-500">
          These settings enable delivery for the task. Each user manages their
          own recipient preferences separately.
        </p>

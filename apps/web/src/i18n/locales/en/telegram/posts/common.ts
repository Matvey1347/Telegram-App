...
const messages = {
  ...
  "telegram.posts.hypotheses": "Content hypotheses",
  "telegram.posts.hypotheses.subtitle":
    "Track theories and compare their post performance.",
  "telegram.posts.hypotheses.new": "New hypothesis",
  "telegram.posts.hypotheses.edit": "Edit hypothesis",
  "telegram.posts.hypotheses.icon": "Emoji",
  "telegram.posts.hypotheses.name": "Name",
  "telegram.posts.hypotheses.description": "Description",
  "telegram.posts.hypotheses.status": "Status",
  "telegram.posts.hypotheses.save": "Save hypothesis",
  "telegram.posts.hypotheses.delete": "Delete",
  "telegram.posts.hypotheses.empty": "No content hypotheses yet.",
  "telegram.posts.hypotheses.loading": "Loading hypotheses…",
  "telegram.posts.hypotheses.loadError": "Could not load hypotheses.",
  "telegram.posts.hypotheses.saveError": "Could not save hypothesis.",
  "telegram.posts.hypotheses.deleteError": "Could not delete hypothesis.",
  "telegram.posts.hypotheses.posts": "{count} linked posts",
  "telegram.posts.hypotheses.views": "Avg. views: {value}",
  "telegram.posts.hypotheses.reactions": "Reactions: {value}%",
  "telegram.posts.hypotheses.comments": "Comments: {value}%",
  "telegram.posts.hypotheses.forwards": "Forwards: {value}%",
  "telegram.posts.hypotheses.subscriberDelta": "Observed subscribers: {value}",
  "telegram.posts.hypotheses.select": "Hypotheses tested by this post",
  "telegram.posts.hypotheses.selectPlaceholder": "Select hypotheses",
  "telegram.posts.hypotheses.assign": "Save hypotheses",
  "telegram.posts.hypotheses.assigned": "Post hypotheses saved",
  "telegram.posts.hypotheses.selectPosts": "Posts assigned to this hypothesis",
  "telegram.posts.hypotheses.selectPostsPlaceholder": "Select posts",
  "telegram.posts.hypotheses.loadingPosts": "Loading posts…",
  "telegram.posts.hypotheses.postsLoadError": "Could not load posts.",
  "telegram.posts.hypotheses.linkedPosts": "Linked posts",
  "telegram.posts.hypotheses.publishedPosts": "Published",
  "telegram.posts.hypotheses.averageViews": "Average views",
  "telegram.posts.hypotheses.reactionRate": "Reaction rate",
  "telegram.posts.hypotheses.commentRate": "Comment rate",
  "telegram.posts.hypotheses.forwardRate": "Forward rate",
  "telegram.posts.hypotheses.subscriberDeltaLabel": "Subscriber change",
  "telegram.posts.hypotheses.actionsNamed": "Actions for {name}",
  "telegram.posts.editor.hypothesis": "Hypothesis",
  "telegram.posts.editor.group": "Group",
  ...
  "telegram.posts.hypotheses.status.ACTIVE": "Active",
  "telegram.posts.hypotheses.status.SUCCESSFUL": "Successful",
  "telegram.posts.hypotheses.status.FAILED": "Failed",
  "telegram.posts.hypotheses.status.ARCHIVED": "Archived",
  "telegram.posts.schedules.chooseSlot": "Publication slot",
  "telegram.posts.schedules.loadingOccurrences": "Loading available slots…",
  "telegram.posts.schedules.occurrencesError":
    "Could not load publication slots",
  "telegram.posts.schedules.selectOccurrence": "Select a scheduled slot",
  "telegram.posts.schedules.available": "Available",
  "telegram.posts.schedules.occupied": "Already scheduled or published",
  "telegram.posts.schedules.past": "Past slot",
  "telegram.posts.schedules.noSlotsForDate": "No assigned slots on this date.",
  "telegram.posts.schedules.customTime": "Custom publication time",
  "telegram.posts.schedules.customTimeHint":
    "Use this only when none of the channel slots fits.",
  "telegram.posts.schedules.slotRequired":
    "Select a publication slot before scheduling.",
  "telegram.posts.schedules.kind.CONTENT": "Regular publication",
  "telegram.posts.schedules.kind.AD": "Advertising / mutual promotion",
  ...
  "telegramPosts.errors.publicationSlotInvalid":
    "The publication slot is unavailable or does not match the selected time.",
  "telegramPosts.errors.publicationSlotOccupied":
    "This publication slot is already used by another post.",
  ...
  "telegram.posts.batch.addViaBot": "Mass Publications",
  "telegram.posts.batch.modalTitle": "Mass Publications",
  "telegram.posts.batch.startBotImport": "Send posts via bot",
  "telegram.posts.batch.sendPostViaBot": "Send post via bot",
  "telegram.posts.batch.writeManually": "Write manually",
  "telegram.posts.batch.createNew": "Create new",
  "telegram.posts.batch.audience": "Publish to",
  "telegram.posts.batch.createError": "Could not create a publication batch.",
  "telegram.posts.batch.preparingBot": "Preparing bot…",
  "telegram.posts.batch.waitingForBot": "Waiting for posts…",
  "telegram.posts.batch.waitingForBotHint":
    "Send the posts to System Bot, then return here. You can check again at any time.",
  "telegram.posts.batch.checkAgain": "Check again",
  "telegram.posts.batch.connectBot": "Connect System Bot",
  "telegram.posts.batch.connectBotHint":
    "Connect the workspace System Bot before importing posts.",
  "telegram.posts.batch.imported":
    "The imported posts are saved as a draft batch.",
  "telegram.posts.batch.importReadError":
    "Could not read the imported posts from System Bot.",
  "telegram.posts.batch.importStartError":
    "Could not start the System Bot import.",
  "telegram.posts.batch.recentBatches": "Recent batches",
  "telegram.posts.batch.createdBatches": "Created mass publications",
  "telegram.posts.batch.savedDrafts": "Saved drafts",
  "telegram.posts.batch.savedDraftsHint":
    "Continue, delete, or start with a clean form.",
  "telegram.posts.batch.noSavedDrafts": "No saved drafts yet.",
  "telegram.posts.batch.noCreatedBatches":
    "No dispatched mass publications yet.",
  "telegram.posts.batch.editDraft": "Edit draft",
  "telegram.posts.batch.editDraftNamed": "Edit draft {title}",
  "telegram.posts.batch.deleteDraft": "Delete draft",
  "telegram.posts.batch.deleteDraftNamed": "Delete draft {title}",
  "telegram.posts.batch.deleteDraftDescription":
    "This saved mass-publication draft will be permanently deleted.",
  "telegram.posts.batch.deleteDraftError":
    "Could not delete the mass-publication draft.",
  "telegram.posts.batch.backToList": "Back to mass publications",
  "telegram.posts.batch.autosavedDrafts": "Autosaved drafts",
  "telegram.posts.batch.untitledDraft": "Unfinished mass publication",
  "telegram.posts.batch.refreshBatches": "Refresh batches",
  "telegram.posts.batch.noBatches": "No publication batches yet.",
  "telegram.posts.batch.listError": "Could not load recent batches.",
  "telegram.posts.batch.detailError": "Could not load this batch.",
  "telegram.posts.batch.listMeta": "{posts} posts · {channels} channels",
  "telegram.posts.batch.batchTitle": "Batch title",
  "telegram.posts.batch.channels": "Publishing channels",
  "telegram.posts.batch.noChannelsSelected": "No channels selected",
  "telegram.posts.batch.defaultLifetime": "Default lifetime",
  "telegram.posts.batch.applyToAllPosts": "Apply to all posts",
  "telegram.posts.batch.lifetime": "Lifetime override",
  "telegram.posts.batch.lifetime24": "Delete after 24 hours",
  "telegram.posts.batch.lifetime48": "Delete after 48 hours",
  "telegram.posts.batch.lifetime72": "Delete after 72 hours",
  "telegram.posts.batch.permanent": "Keep permanently",
  "telegram.posts.batch.postNumber": "Post {number}",
  "telegram.posts.batch.addPost": "Add another post",
  "telegram.posts.batch.publications": "Publications",
  "telegram.posts.batch.preview": "Preview",
  "telegram.posts.batch.previewChannel": "Telegram channel",
  "telegram.posts.batch.postTitle": "Internal post title",
  "telegram.posts.batch.telegramText": "Telegram text",
  "telegram.posts.batch.mediaCount": "Media: {count}",
  "telegram.posts.batch.action": "Publishing action",
  "telegram.posts.batch.publishNow": "Publish now",
  "telegram.posts.batch.schedule": "Schedule",
  "telegram.posts.batch.date": "Publication date",
  "telegram.posts.batch.time": "Publication time",
  "telegram.posts.batch.longTextMode": "Long text mode",
  "telegram.posts.batch.imagesThenText": "Images, then text",
  "telegram.posts.batch.captionThenText": "Caption, then remaining text",
  "telegram.posts.batch.imagesThenTextHint":
    "Send the media first, then send long text as a separate message.",
  "telegram.posts.batch.captionThenTextHint":
    "Fill the media caption up to Telegram’s limit, then send the remaining text separately.",
  "telegram.posts.batch.channelOverrides": "Channel overrides ({count})",
  "telegram.posts.batch.inheritAction": "Use post action",
  "telegram.posts.batch.clearOverride": "Clear channel override",
  "telegram.posts.batch.overrideDate": "Override date for {channel}",
  "telegram.posts.batch.overrideTime": "Override time for {channel}",
  "telegram.posts.batch.saving": "Saving…",
  "telegram.posts.batch.saveAndDispatch": "Save and dispatch",
  "telegram.posts.batch.dispatching": "Dispatching…",
  "telegram.posts.batch.saveError": "Could not save this batch.",
  "telegram.posts.batch.dispatchError": "Could not dispatch this batch.",
  "telegram.posts.batch.readOnlyAfterDispatch":
    "This batch has been dispatched. Its delivery state is read-only.",
  "telegram.posts.batch.validation.title": "Enter a batch title.",
  "telegram.posts.batch.validation.channels": "Select at least one channel.",
  "telegram.posts.batch.validation.postTitle": "Every post needs a title.",
  "telegram.posts.batch.validation.schedule":
    "Add a valid date and time to every scheduled post and override.",
  "telegram.posts.batch.deliveries": "Delivery status",
  "telegram.posts.batch.manualRefreshHint":
    "Statuses update only when you refresh; no background polling is used.",
  "telegram.posts.batch.refreshDeliveries": "Refresh deliveries",
  "telegram.posts.batch.deliveriesError": "Could not load deliveries.",
  "telegram.posts.batch.noDeliveries": "No deliveries have been created yet.",
  "telegram.posts.batch.deliveryStatus":
    "Delivery: {status} · Telegram: {remote}",
  "telegram.posts.batch.deletesIn": "Deletes {time}",
  "telegram.posts.batch.deletionDue": "Deletion is due",
  "telegram.posts.batch.deleted": "Deleted",
  "telegram.posts.batch.openTelegram": "Open in Telegram",

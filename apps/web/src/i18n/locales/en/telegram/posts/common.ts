...
const messages = {
  ...
  "telegram.posts.hypotheses.subtitle": "Track theories and compare their post performance.",
  ...
  "telegram.posts.hypotheses.status.DRAFT": "Draft",
  ...
  "telegram.posts.schedules.occurrencesError": "Could not load publication slots",
  "telegram.posts.schedules.selectOccurrence": "Select a scheduled slot",
  "telegram.posts.schedules.slotRequired": "Select a publication slot before scheduling.",
  "telegram.posts.schedules.kind.CONTENT": "Regular publication",
  "telegram.posts.schedules.kind.AD": "Advertising",
  "telegram.posts.schedules.kind.MUTUAL_PROMOTION": "Mutual promotion",
  ...
  "telegram.posts.batch.addViaBot": "Add via bot",
  "telegram.posts.batch.modalTitle": "Posts from System Bot",
  "telegram.posts.batch.startBotImport": "Add posts via bot",
  ...
  "telegram.posts.batch.noBatches": "No imported batches yet.",
  ...
  "telegram.posts.batch.editor": "Batch editor",
  "telegram.posts.batch.statusLabel": "Status: {status}",
  ...
  "telegram.posts.batch.saveDraft": "Save draft",
  ...
  "telegram.posts.batch.associations": "Attach to a workflow",
  "telegram.posts.batch.associationsHint":
    "Optionally connect this batch to an ad sale or mutual promotion folder.",
  "telegram.posts.batch.associationType": "Workflow type",
  "telegram.posts.batch.associationTarget": "Workflow",
  "telegram.posts.batch.adSale": "Ad sale",
  "telegram.posts.batch.mutualPromotion": "Mutual promotion folder",
  "telegram.posts.batch.chooseTarget": "Choose a workflow",
  "telegram.posts.batch.loadingTargets": "Loading workflows…",
  "telegram.posts.batch.targetsError": "Could not load available workflows.",
  "telegram.posts.batch.attach": "Attach",
  "telegram.posts.batch.attachError": "Could not attach this batch.",

...
const messages = {
  ...
  "telegram.posts.hypotheses": "Контент-гипотезы",
  "telegram.posts.hypotheses.subtitle":
    "Проверяйте теории и сравнивайте результаты публикаций.",
  "telegram.posts.hypotheses.new": "Новая гипотеза",
  "telegram.posts.hypotheses.edit": "Редактировать гипотезу",
  "telegram.posts.hypotheses.icon": "Эмодзи",
  "telegram.posts.hypotheses.name": "Название",
  "telegram.posts.hypotheses.description": "Описание",
  "telegram.posts.hypotheses.status": "Статус",
  "telegram.posts.hypotheses.save": "Сохранить гипотезу",
  "telegram.posts.hypotheses.delete": "Удалить",
  "telegram.posts.hypotheses.empty": "Контент-гипотез пока нет.",
  "telegram.posts.hypotheses.loading": "Загрузка гипотез…",
  "telegram.posts.hypotheses.loadError": "Не удалось загрузить гипотезы.",
  "telegram.posts.hypotheses.saveError": "Не удалось сохранить гипотезу.",
  "telegram.posts.hypotheses.deleteError": "Не удалось удалить гипотезу.",
  "telegram.posts.hypotheses.posts": "Связано публикаций: {count}",
  "telegram.posts.hypotheses.views": "Средние просмотры: {value}",
  "telegram.posts.hypotheses.reactions": "Реакции: {value}%",
  "telegram.posts.hypotheses.comments": "Комментарии: {value}%",
  "telegram.posts.hypotheses.forwards": "Пересылки: {value}%",
  "telegram.posts.hypotheses.subscriberDelta":
    "Наблюдаемое изменение подписчиков: {value}",
  "telegram.posts.hypotheses.select": "Гипотезы, проверяемые публикацией",
  "telegram.posts.hypotheses.selectPlaceholder": "Выберите гипотезы",
  "telegram.posts.hypotheses.assign": "Сохранить гипотезы",
  "telegram.posts.hypotheses.assigned": "Гипотезы публикации сохранены",
  "telegram.posts.hypotheses.selectPosts": "Публикации этой гипотезы",
  "telegram.posts.hypotheses.selectPostsPlaceholder": "Выберите публикации",
  "telegram.posts.hypotheses.loadingPosts": "Загрузка публикаций…",
  "telegram.posts.hypotheses.postsLoadError":
    "Не удалось загрузить публикации.",
  "telegram.posts.hypotheses.linkedPosts": "Связано публикаций",
  "telegram.posts.hypotheses.publishedPosts": "Опубликовано",
  "telegram.posts.hypotheses.averageViews": "Средние просмотры",
  "telegram.posts.hypotheses.reactionRate": "Доля реакций",
  "telegram.posts.hypotheses.commentRate": "Доля комментариев",
  "telegram.posts.hypotheses.forwardRate": "Доля пересылок",
  "telegram.posts.hypotheses.subscriberDeltaLabel": "Изменение подписчиков",
  "telegram.posts.hypotheses.actionsNamed": "Действия для {name}",
  "telegram.posts.editor.hypothesis": "Гипотеза",
  "telegram.posts.editor.group": "Группа",
  ...
  "telegram.posts.groups.notUsed": "Эта публикация пока нигде не используется",
  "telegram.posts.hypotheses.status.ACTIVE": "Активна",
  "telegram.posts.hypotheses.status.SUCCESSFUL": "Успешна",
  "telegram.posts.hypotheses.status.FAILED": "Неуспешна",
  "telegram.posts.hypotheses.status.ARCHIVED": "В архиве",
  "telegram.posts.schedules.chooseSlot": "Слот публикации",
  "telegram.posts.schedules.loadingOccurrences": "Загрузка доступных слотов…",
  "telegram.posts.schedules.occurrencesError":
    "Не удалось загрузить слоты публикаций",
  "telegram.posts.schedules.selectOccurrence": "Выберите запланированный слот",
  "telegram.posts.schedules.available": "Доступен",
  "telegram.posts.schedules.occupied": "Уже запланирован или опубликован",
  "telegram.posts.schedules.past": "Время прошло",
  "telegram.posts.schedules.noSlotsForDate":
    "На эту дату у канала нет назначенных слотов.",
  "telegram.posts.schedules.customTime": "Своё время публикации",
  "telegram.posts.schedules.customTimeHint":
    "Используйте, только если ни один слот канала не подходит.",
  "telegram.posts.schedules.slotRequired":
    "Перед планированием выберите слот публикации.",
  "telegram.posts.schedules.kind.CONTENT": "Обычная публикация",
  "telegram.posts.schedules.kind.AD": "Реклама / ВП",
  ...
  "telegramPosts.errors.publicationSlotInvalid":
    "Слот публикации недоступен или не соответствует выбранному времени.",
  "telegramPosts.errors.publicationSlotOccupied":
    "Этот слот уже занят другой публикацией.",
  ...
  "telegram.posts.batch.addViaBot": "Массовые публикации",
  "telegram.posts.batch.modalTitle": "Массовые публикации",
  "telegram.posts.batch.startBotImport": "Отправить через бота",
  "telegram.posts.batch.sendPostViaBot": "Отправить пост через бота",
  "telegram.posts.batch.writeManually": "Написать вручную",
  "telegram.posts.batch.createNew": "Создать новый",
  "telegram.posts.batch.audience": "Опубликовать в",
  "telegram.posts.batch.createError": "Не удалось создать пакет публикаций.",
  "telegram.posts.batch.preparingBot": "Подготавливаем бота…",
  "telegram.posts.batch.waitingForBot": "Ожидаем публикации…",
  "telegram.posts.batch.waitingForBotHint":
    "Отправьте публикации системному боту и вернитесь сюда. Проверку можно повторить в любой момент.",
  "telegram.posts.batch.checkAgain": "Проверить снова",
  "telegram.posts.batch.connectBot": "Подключить системного бота",
  "telegram.posts.batch.connectBotHint":
    "Подключите системного бота рабочего пространства перед импортом.",
  "telegram.posts.batch.imported":
    "Импортированные публикации сохранены как пакет-черновик.",
  "telegram.posts.batch.importReadError":
    "Не удалось получить публикации из системного бота.",
  "telegram.posts.batch.importStartError":
    "Не удалось запустить импорт через системного бота.",
  "telegram.posts.batch.recentBatches": "Недавние пакеты",
  "telegram.posts.batch.createdBatches": "Созданные массовые публикации",
  "telegram.posts.batch.savedDrafts": "Сохранённые черновики",
  "telegram.posts.batch.savedDraftsHint":
    "Продолжите, удалите или начните с чистой формы.",
  "telegram.posts.batch.noSavedDrafts": "Сохранённых черновиков пока нет.",
  "telegram.posts.batch.noCreatedBatches":
    "Отправленных массовых публикаций пока нет.",
  "telegram.posts.batch.editDraft": "Редактировать черновик",
  "telegram.posts.batch.editDraftNamed": "Редактировать черновик {title}",
  "telegram.posts.batch.deleteDraft": "Удалить черновик",
  "telegram.posts.batch.deleteDraftNamed": "Удалить черновик {title}",
  "telegram.posts.batch.deleteDraftDescription":
    "Этот черновик массовой публикации будет удалён без возможности восстановления.",
  "telegram.posts.batch.deleteDraftError":
    "Не удалось удалить черновик массовой публикации.",
  "telegram.posts.batch.backToList": "Назад к массовым публикациям",
  "telegram.posts.batch.autosavedDrafts": "Автосохранённые черновики",
  "telegram.posts.batch.untitledDraft": "Незавершённая массовая публикация",
  "telegram.posts.batch.refreshBatches": "Обновить пакеты",
  "telegram.posts.batch.noBatches": "Пакетов публикаций пока нет.",
  "telegram.posts.batch.listError": "Не удалось загрузить недавние пакеты.",
  "telegram.posts.batch.detailError": "Не удалось загрузить этот пакет.",
  "telegram.posts.batch.listMeta": "Публикаций: {posts} · каналов: {channels}",
  "telegram.posts.batch.batchTitle": "Название пакета",
  "telegram.posts.batch.channels": "Каналы публикации",
  "telegram.posts.batch.noChannelsSelected": "Каналы не выбраны",
  "telegram.posts.batch.defaultLifetime": "Срок публикаций по умолчанию",
  "telegram.posts.batch.applyToAllPosts": "Применить ко всем публикациям",
  "telegram.posts.batch.lifetime": "Индивидуальный срок",
  "telegram.posts.batch.lifetime24": "Удалить через 24 часа",
  "telegram.posts.batch.lifetime48": "Удалить через 48 часов",
  "telegram.posts.batch.lifetime72": "Удалить через 72 часа",
  "telegram.posts.batch.permanent": "Оставить навсегда",
  "telegram.posts.batch.postNumber": "Публикация {number}",
  "telegram.posts.batch.addPost": "Добавить ещё публикацию",
  "telegram.posts.batch.publications": "Публикации",
  "telegram.posts.batch.preview": "Предпросмотр",
  "telegram.posts.batch.previewChannel": "Telegram-канал",
  "telegram.posts.batch.postTitle": "Внутреннее название",
  "telegram.posts.batch.telegramText": "Текст для Telegram",
  "telegram.posts.batch.mediaCount": "Медиа: {count}",
  "telegram.posts.batch.action": "Действие",
  "telegram.posts.batch.publishNow": "Опубликовать сейчас",
  "telegram.posts.batch.schedule": "Запланировать",
  "telegram.posts.batch.date": "Дата публикации",
  "telegram.posts.batch.time": "Время публикации",
  "telegram.posts.batch.longTextMode": "Режим длинного текста",
  "telegram.posts.batch.imagesThenText": "Сначала изображения, затем текст",
  "telegram.posts.batch.captionThenText": "Подпись, затем оставшийся текст",
  "telegram.posts.batch.imagesThenTextHint":
    "Сначала отправить медиа, а длинный текст — отдельным сообщением после него.",
  "telegram.posts.batch.captionThenTextHint":
    "Заполнить подпись к медиа до лимита Telegram, а остаток текста отправить отдельным сообщением.",
  "telegram.posts.batch.channelOverrides": "Настройки каналов ({count})",
  "telegram.posts.batch.inheritAction": "Использовать действие публикации",
  "telegram.posts.batch.clearOverride": "Сбросить настройку канала",
  "telegram.posts.batch.overrideDate": "Отдельная дата для {channel}",
  "telegram.posts.batch.overrideTime": "Отдельное время для {channel}",
  "telegram.posts.batch.saving": "Сохраняем…",
  "telegram.posts.batch.saveAndDispatch": "Сохранить и запустить",
  "telegram.posts.batch.dispatching": "Запускаем…",
  "telegram.posts.batch.saveError": "Не удалось сохранить пакет.",
  "telegram.posts.batch.dispatchError": "Не удалось запустить пакет.",
  "telegram.posts.batch.readOnlyAfterDispatch":
    "Пакет уже запущен. Состояние его доставок доступно только для чтения.",
  "telegram.posts.batch.validation.title": "Укажите название пакета.",
  "telegram.posts.batch.validation.channels": "Выберите хотя бы один канал.",
  "telegram.posts.batch.validation.postTitle":
    "Укажите название каждой публикации.",
  "telegram.posts.batch.validation.schedule":
    "Укажите корректные дату и время для всех запланированных публикаций и настроек каналов.",
  "telegram.posts.batch.deliveries": "Статус доставки",
  "telegram.posts.batch.manualRefreshHint":
    "Статусы обновляются вручную; фоновый опрос не используется.",
  "telegram.posts.batch.refreshDeliveries": "Обновить доставки",
  "telegram.posts.batch.deliveriesError": "Не удалось загрузить доставки.",
  "telegram.posts.batch.noDeliveries": "Доставки пока не созданы.",
  "telegram.posts.batch.deliveryStatus":
    "Доставка: {status} · Telegram: {remote}",
  "telegram.posts.batch.deletesIn": "Удаление {time}",
  "telegram.posts.batch.deletionDue": "Пора удалить",
  "telegram.posts.batch.deleted": "Удалено",
  "telegram.posts.batch.openTelegram": "Открыть в Telegram",

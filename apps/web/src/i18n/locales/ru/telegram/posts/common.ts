...
const messages = {
  ...
  "telegram.posts.hypotheses.subtitle": "Проверяйте теории и сравнивайте результаты публикаций.",
  ...
  "telegram.posts.hypotheses.subscriberDelta": "Наблюдаемое изменение подписчиков: {value}",
  ...
  "telegram.posts.hypotheses.status.DRAFT": "Черновик",
  ...
  "telegram.posts.schedules.occurrencesError": "Не удалось загрузить слоты публикаций",
  "telegram.posts.schedules.selectOccurrence": "Выберите запланированный слот",
  "telegram.posts.schedules.slotRequired": "Перед планированием выберите слот публикации.",
  "telegram.posts.schedules.kind.CONTENT": "Обычная публикация",
  "telegram.posts.schedules.kind.AD": "Реклама",
  "telegram.posts.schedules.kind.MUTUAL_PROMOTION": "Взаимопиар",
  ...
  "telegram.posts.batch.addViaBot": "Добавить через бота",
  "telegram.posts.batch.modalTitle": "Публикации из системного бота",
  "telegram.posts.batch.startBotImport": "Добавить через бота",
  ...
  "telegram.posts.batch.noBatches": "Импортированных пакетов пока нет.",
  ...
  "telegram.posts.batch.editor": "Редактор пакета",
  "telegram.posts.batch.statusLabel": "Статус: {status}",
  ...
  "telegram.posts.batch.saveDraft": "Сохранить черновик",
  ...
  "telegram.posts.batch.associations": "Связать с процессом",
  "telegram.posts.batch.associationsHint":
    "При необходимости свяжите пакет с продажей рекламы или папкой взаимного пиара.",
  "telegram.posts.batch.associationType": "Тип процесса",
  "telegram.posts.batch.associationTarget": "Процесс",
  "telegram.posts.batch.adSale": "Продажа рекламы",
  "telegram.posts.batch.mutualPromotion": "Папка взаимного пиара",
  "telegram.posts.batch.chooseTarget": "Выберите процесс",
  "telegram.posts.batch.loadingTargets": "Загружаем процессы…",
  "telegram.posts.batch.targetsError":
    "Не удалось загрузить доступные процессы.",
  "telegram.posts.batch.attach": "Связать",
  "telegram.posts.batch.attachError": "Не удалось связать этот пакет.",

...
const messages = {
  ...
  "telegram.posts.batch.sendPostsViaBot": "Отправить посты через бота",
  ...
  "telegram.posts.batch.formatForAll": "Формат для всех",
  "telegram.posts.batch.mixedFormat": "Смешанный / по умолчанию",
  "telegram.posts.batch.format": "Формат",
  ...
  "telegram.posts.batch.deletePost": "Удалить {title}",
  ...
  "telegram.posts.batch.icon": "Значок",
  "telegram.posts.batch.postTitle": "Название публикации",
  ...
  "telegram.posts.batch.toggleChannelSchedule":
    "Показать расписание для {channel}",

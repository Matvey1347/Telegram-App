...
| # | File | Lines | Category |
|---:|---|---:|---|
| 1 | `apps/api/src/domains/telegram/telegram-channels/telegram-channels.service.ts` | 11019 | backend |
| 2 | `apps/web/src/app/(telegram)/telegram-posts/page.tsx` | 6775 | frontend |
| 3 | `apps/api/src/domains/telegram/telegram-ad-sales/telegram-ad-sales.service.ts` | 5746 | backend |
| 4 | `apps/web/src/app/(telegram)/telegram/channels/[id]/page.tsx` | 4000 | frontend |
| 5 | `apps/web/src/app/(telegram)/telegram-channels/page.tsx` | 3502 | frontend |
| 6 | `apps/api/src/telegram/shared/telegram-mtproto.client.ts` | 3360 | backend |
| 7 | `apps/web/src/components/features/growth/ad-sales/ad-sales-page.tsx` | 3102 | frontend |
| 8 | `apps/web/src/app/(growth)/ad-campaigns/page.tsx` | 2503 | frontend |
| 9 | `apps/web/src/lib/api.ts` | 2235 | frontend |
| 10 | `apps/api/src/domains/growth/ad-campaigns/ad-campaigns.service.ts` | 1864 | backend |
| 11 | `apps/web/src/components/ui/primitives.tsx` | 1854 | frontend |
| 12 | `apps/web/src/components/features/growth/ad-campaigns/campaigns-table.tsx` | 1307 | frontend |
| 13 | `apps/api/src/domains/telegram/telegram-user-accounts/telegram-user-accounts.service.ts` | 1217 | backend |
| 14 | `apps/web/src/components/features/telegram/telegram/telegram-account-panels.tsx` | 1178 | frontend |
| 15 | `apps/web/src/components/icons/icon-picker.tsx` | 1111 | frontend |
| 16 | `apps/web/src/components/features/growth/ad-sales/ad-sale-modal.tsx` | 1048 | frontend |
| 17 | `apps/api/src/domains/growth/ad-campaigns/ad-campaign-admission-analytics.service.ts` | 1010 | backend |
| 18 | `apps/api/src/domains/growth/ad-hypotheses/ad-hypotheses.service.ts` | 902 | backend |
| 19 | `apps/web/src/components/features/telegram/telegram/telegram-post-preview.tsx` | 897 | frontend |
| 20 | `packages/shared/src/types/telegram-ad-sales.ts` | 857 | shared |
| 21 | `apps/api/src/domains/finance/transactions/transactions.service.ts` | 818 | backend |
| 22 | `apps/web/src/app/(operations)/system-logs/page.tsx` | 806 | frontend |
| 23 | `apps/web/src/components/features/telegram/telegram/telegram-text-editor.tsx` | 720 | frontend |
| 24 | `apps/api/src/domains/telegram/telegram-channels/telegram-channels.controller.ts` | 648 | backend |
| 25 | `apps/web/src/app/page.tsx` | 629 | frontend |
| 26 | `apps/api/src/domains/telegram/telegram-ad-sales/telegram-ad-sales.controller.ts` | 628 | backend |
| 27 | `apps/api/src/domains/operations/dashboard/dashboard.service.ts` | 617 | backend |
...
| 30 | `apps/api/src/domains/telegram/telegram-ad-sales/dto.ts` | 547 | backend |
...
- `apps/web/src/lib/api.ts` was a single API choke point. Type-only contracts now live in domain modules under `apps/web/src/lib/api-types/`, `apps/web/src/lib/api-types.ts` is only a compatibility barrel, and `applicationLogsApi` has moved to `apps/web/src/lib/features/operations/application-logs-api.ts`; remaining domain endpoint facades still need to split.
...
- `apps/web/src/app/(telegram)/telegram-posts/page.tsx`: React Query, composer state, schedule logic, groups, modals and rendering in one page.
- `apps/web/src/app/(telegram)/telegram/channels/[id]/page.tsx`: data loading, analytics normalization, settings, posts, charts, sync and access modals in one page.
- `apps/web/src/components/features/growth/ad-sales/ad-sales-page.tsx`: route-tab state, product pricing, calendar rendering, sale lifecycle and settings in one component.
- `apps/api/src/domains/telegram/telegram-channels/telegram-channels.service.ts`: orchestration, domain rules, Telegram adapter calls and Prisma persistence in one service.
- `apps/api/src/domains/telegram/telegram-ad-sales/telegram-ad-sales.service.ts`: lifecycle, analytics, inventory, CRM and payments in one service.

...
const pageHookAllowances = [
  ["(finance)/accounts/page.tsx", 8],
  ["(finance)/categories/page.tsx", 9],
  ["(finance)/currencies/page.tsx", 6],
  ["(finance)/finance/page.tsx", 10],
  ["(finance)/transactions/page.tsx", 14],
  ...
  ["(telegram)/telegram-channels/page.tsx", 20],
  ["(telegram)/telegram-posts/page.tsx", 21],
